...
for channel in channels:    
    ...
    well_save_path = f'/home/ecdyer/labshare/WETLAB/WetLab_Shared/test_10X/data_selected/results/16-bit_well_segmentation_{channel}/stacks'
    grid_def_path = f'/home/ecdyer/labshare/WETLAB/WetLab_Shared/test_10X/data_selected/results/16-bit_well_segmentation_{channel}/reference_grids'
    grid_vis_path = f'/home/ecdyer/labshare/WETLAB/WetLab_Shared/test_10X/data_selected/results/16-bit_well_segmentation_{channel}/visualizations'

    # Get the field directories
    data_dir = '/home/ecdyer/labshare/WETLAB/WetLab_Shared/test_10X/data_selected'
